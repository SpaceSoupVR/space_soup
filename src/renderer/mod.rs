...
impl Default for Color3 {
    fn default() -> Self { Color3(255, 255, 255, 255) }
}
...
impl Renderer {
    ...
    pub fn create_panel(
        ...
        WorldPanel::new(
            &self.device, &self.queue, texture_format, &self.mesh_pipeline,
            width_px, height_px, width_m, height_m,
        )
    }
...

        {
            let mut pass = encoder.begin_render_pass(&RenderPassDescriptor {
                ...
                color_attachments: &[Some(RenderPassColorAttachment {
                    ...
                    resolve_target: None,
                    ops: Operations {
                        load:  LoadOp::Clear(wgpu::Color { r: 0.02, g: 0.02, b: 0.05, a: 1.0 }),
                        store: StoreOp::Store,
                    },
                })],
